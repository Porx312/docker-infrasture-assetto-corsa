...
SERVER_STATUS_HEARTBEAT_WHEN_EMPTY = _env_bool("SERVER_STATUS_HEARTBEAT_WHEN_EMPTY", "false")
...
BATTLE_SYNC_TRACE = _env_bool("BATTLE_SYNC_TRACE", "false")
BATTLE_CHAT_ENABLED = _env_bool("BATTLE_CHAT_ENABLED", "true")
BATTLE_DECLINED_NOTIFY_ENABLED = _env_bool("BATTLE_DECLINED_NOTIFY_ENABLED", "true")
BATTLE_DECLINED_NOTIFY_COOLDOWN_SEC = _env_float("BATTLE_DECLINED_NOTIFY_COOLDOWN_SEC", "30.0")
BATTLE_DECLINED_OPPONENT_MESSAGE = os.getenv(
    "BATTLE_DECLINED_OPPONENT_MESSAGE",
    "{player} don't accept battles.",
).strip()
HUD_BATTLE_TTL_SEC = _env_int("HUD_BATTLE_TTL_SEC", "120")
HUD_BATTLE_DEBOUNCE_MS = _env_int("HUD_BATTLE_DEBOUNCE_MS", "300")
HUD_BATTLE_ARMING_PUBLISH_MIN_MS = _env_int("HUD_BATTLE_ARMING_PUBLISH_MIN_MS", "500")
...
BATTLE_ARM_MAX_GAP_METERS = _env_float("BATTLE_ARM_MAX_GAP_METERS", "30.0")
BATTLE_ARM_ABORT_GAP_METERS = _env_float("BATTLE_ARM_ABORT_GAP_METERS", "33.0")
if BATTLE_ARM_ABORT_GAP_METERS <= BATTLE_ARM_MAX_GAP_METERS:
    BATTLE_ARM_ABORT_GAP_METERS = BATTLE_ARM_MAX_GAP_METERS + 3.0
BATTLE_ARM_ABORT_GRACE_SEC = _env_float("BATTLE_ARM_ABORT_GRACE_SEC", "0.4")
BATTLE_ARM_MIN_SPEED_KMH = _env_float("BATTLE_ARM_MIN_SPEED_KMH", "20.0")
BATTLE_ARM_CANCEL_SPEED_KMH = _env_float("BATTLE_ARM_CANCEL_SPEED_KMH", "20.0")
